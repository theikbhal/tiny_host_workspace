...
The Tiiny Host API uses API keys to authenticate requests. You can view and manage your API keys in the [Tiiny Host Dashboard](https://host.naml.in/manage/account).
